...
func clearConfigEnvironment(t *testing.T) {
	...
	for _, key := range []string{
		...
		"CROWSNEST_DELIVERY_POLL_INTERVAL", "CROWSNEST_RECONCILE_INTERVAL", "CROWSNEST_IDENTITY_SYNC_ENABLED", "CROWSNEST_IDENTITY_SYNC_DRY_RUN", "CROWSNEST_IDENTITY_SYNC_INTERVAL", "CROWSNEST_RECIPIENT_ALLOWLIST", "CROWSNEST_ALLOWED_EMAIL_DOMAINS", "CROWSNEST_GITLAB_BASE_URL",
